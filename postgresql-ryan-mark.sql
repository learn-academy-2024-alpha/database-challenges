...
-- SELECT name, COUNT(name) AS countries_with_z
-- FROM country
-- WHERE name like '%z%'
-- GROUP BY name
-- SUM(countries_with_z) AS sumcountries_with_z
...
SELECT *, (SELECT SUM(countries_with_z) FROM country_list) AS sumcountries_with_z
FROM country_list;
...
SELECT name, gnp, per_capita_gnp
FROM smallest_pop
